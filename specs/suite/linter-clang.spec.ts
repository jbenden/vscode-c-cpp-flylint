...
describe("Clang parser", () => {
    ...
    test("should find the actual Clang executable", async () => {
        ...
        expect(exe).toBe('clang');
    });

    test("should NOT find a missing Clang executable", async () => {
        // GIVEN
        ...
        await linter['maybeEnable']()
            ...
            .catch((e: Error) => {
                expect(e.message).toEqual('The executable was not found for Clang, disabling linter');
            });
    });
