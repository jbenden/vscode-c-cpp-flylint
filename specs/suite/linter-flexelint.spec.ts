...
describe("Flexelint parser", () => {
    ...
    test("should find the actual Flexelint executable", async () => {
        ...
        expect(exe).toBe('flexelint');
    });

    test("should NOT find a missing Flexelint executable", async () => {
        // GIVEN
        ...
        await linter['maybeEnable']()
            ...
            .catch((e: Error) => {
                expect(e.message).toEqual('The executable was not found for Flexelint, disabling linter');
            });
    });
